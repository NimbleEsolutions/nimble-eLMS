...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url(); ?>/public/dist/img/nimble.png" type="image/x-icon">
  <title>eLMS | <?= ($uri->getSegment(1) == 'home' ? 'Home' : null)?> <?= ($uri->getSegment(1) == 'user' ? 'Users' : null)?> <?= ($uri->getSegment(1) == 'assignment' ? 'Assignments' : null)?> <?= ($uri->getSegment(1) == 'programs' ? 'Programs' : null)?></title>
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        <a href="" class="navbar-brand">
          <img src="<?= base_url(); ?>/public/dist/img/nimble_logo.png" alt="Monjin Logo" class="brand-image img-circle elevation-3">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <ul class="navbar-nav">
            ...
            <?php if(session()->get('role_id') == '1'){?>
            <li class="nav-item dropdown">
              <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle <?= ($uri->getSegment(1) == 'assignment' ? 'active' : null)?>">Assignments</a>
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?= site_url('assignment/stage_details');?>" class="dropdown-item">Create Stages </a></li>
                <li><a href="<?= site_url('assignment/module_details');?>" class="dropdown-item">Create Module </a></li>
                <li><a href="<?= site_url('assignment/topic_details'); ?>" class="dropdown-item">Create Module Topic</a></li>
                <li><a href="<?= site_url('assignment/topic_assignment_details'); ?>" class="dropdown-item">Create Topic Assignments</a></li>
              </ul>
            </li>
            <?php } ?>
          </ul>
